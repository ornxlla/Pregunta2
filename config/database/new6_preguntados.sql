...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-06-2024 a las 22:22:58
...
(6, 2, 0, '2024-06-23 19:37:15', '2024-06-23 19:37:59'),
(7, 2, 0, '2024-06-23 19:38:34', '2024-06-23 19:38:36'),
(8, 2, 0, '2024-06-23 19:38:38', '2024-06-23 19:38:40'),
(9, 2, 0, '2024-06-23 19:38:41', '2024-06-23 19:38:51'),
(10, 3, 0, '2024-06-23 19:39:16', '2024-06-23 19:39:17'),
(11, 4, 0, '2024-06-23 21:49:54', '0000-00-00 00:00:00');
...
INSERT INTO `partida_clasica_respuestas` (`id`, `id_jugador`, `id_partida`, `id_pregunta`, `acertado`) VALUES
(1, 2, 6, 20, 1),
(2, 2, 6, 13, 1),
(3, 2, 6, 17, 1),
(4, 2, 6, 1, 1),
...
INSERT INTO `preguntas_listado` (`id_pregunta`, `texto`, `id_tematica`, `id_dificultad`, `aprobado`, `es_sugerida`) VALUES
(1, '¿Cual es el resultado de la siguiente cuenta? ( 9 + 5 ) * 4 ', 1, 1, 1, 0),
(2, '¿Quién fue el primer presidente de Estados Unidos?', 2, 1, 1, 0),
(3, '¿Cómo se apellidan los cuatro integrantes de Los Simuladores?', 6, 1, 1, 0),
(4, '¿Cuál es la fórmula para calcular el área de un círculo?', 1, 2, 1, 0),
(5, '¿Quién fue el primer presidente de Estados Unidos?', 2, 2, 1, 0),
(6, '¿Qué es la mitosis?', 3, 3, 1, 0),
(7, '¿Cuál es la capital de Francia?', 4, 1, 1, 0),
(8, '¿Cuánto es la raíz cuadrada de 25?', 1, 2, 1, 0),
(9, '¿En qué año se firmó la Declaración de Independencia de Estados Unidos?', 2, 3, 1, 0),
(10, '¿Cuál es el símbolo químico del agua?', 3, 1, 1, 0),
(11, '¿Dónde se encuentra la Gran Barrera de Coral?', 4, 2, 1, 0),
(12, '¿Cuántos lados tiene un hexágono?', 1, 3, 1, 0),
(13, '¿Quién fue el líder de la Revolución Rusa en 1917?', 2, 2, 1, 0),
(14, '¿Cual es la capital de Argentina?', 4, 1, 1, 0),
(15, '¿Cuando es 3 + 4 * 2?', 1, 1, 1, 0),
(16, 'En que año termino la primera guerra mundial?', 2, 1, 1, 0),
(17, '¿Cual es el simbolo quimico de oxigeno?', 7, 1, 1, 0),
(18, '¿Cual es el oceano mas grande del mundo)', 4, 1, 1, 0),
(19, '¿Cual es el resultado de 5+15?', 1, 1, 1, 0),
(20, '¿Cual es la formula del area de un triangulo?', 1, 2, 1, 0),
(21, '¿Quien fue el primer emperador romano?', 2, 2, 1, 0),
(22, '¿Que elemento quimico tiene el simbolo \"Fe\"?', 3, 2, 1, 0),
(23, '¿Cual es el pais mas grande del mundo por area de tierra?', 4, 2, 1, 0),
(24, '¿Cual es el pH del agua pura?', 7, 2, 1, 0),
(25, '¿Cual es el resultado de 13x0 + 13?', 1, 2, 1, 0),
(26, '¿Cual es el resultado de 12/2*3?', 1, 3, 1, 0),
(27, '¿Cual fue la batalla que marco el fin de la guerra de los Cien Años?', 2, 3, 1, 0),
(30, '¿Cuál es la raíz cuadrada de 256?', 1, 1, 1, 0),
(31, '¿Cuántos dientes tienen los humanos?', 3, 1, 1, 0),
(32, '¿Cuál es el océano más grande del mundo?', 4, 1, 1, 0),
(33, 'En la película \"La Sirenita\", ¿Para qué utiliza Ariel un tenedor?', 6, 1, 1, 0),
(34, '¿Cuántos mares existen en la Tierra?', 4, 1, 1, 0);
...
--
ALTER TABLE `preguntas_listado`
  MODIFY `id_pregunta` int(255) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
...
--
ALTER TABLE `respuesta_listado`
  MODIFY `id_respuesta` int(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=174;
