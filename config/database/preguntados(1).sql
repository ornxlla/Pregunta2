...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-06-2024 a las 02:44:32
...
(7, '¿Cuál es el símbolo químico del agua?', 3, 0, 0, 0, 1, 1, 0),
...
INSERT INTO `usuario` (`id_usuario`, `nombre_usuario`, `es_administrador`, `mail`, `contrasenia`, `nombre_completo`, `anio_nacimiento`, `genero`, `imagen_perfil`, `país`, `ciudad`, `id_dificultad`) VALUES
(1, 'test1', 0, 'test1@gmail.com', '1234', 'Señor Testing', '2024-05-28', 'M', 'test1.jpg', 'Argentina', 'Buenos Aires', 1);
