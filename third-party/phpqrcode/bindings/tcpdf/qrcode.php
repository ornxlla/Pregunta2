...
use use alphabetuse b1;use barcode;use BCH;use blocks;use counter;use data;use direction;use Encoding;use frame;use input;use items;use Levels;use mask;use parity;use QR;use Reeduse run;use single;use structured;use value;use width;use X;use Y;use function str_split;if (!defined('QRCODEDEFS')) {
...
if (!class_exists('phpqrcode\bindings\tcpdf\QRcode', false)) {
